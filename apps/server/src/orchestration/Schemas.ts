import {
  ...
  ThreadTranscriptReplacedPayload as ContractsThreadTranscriptReplacedPayloadSchema,
...
export const ThreadTranscriptReplacedPayload = ContractsThreadTranscriptReplacedPayloadSchema;
