...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  const baseDir = Option.getOrElse(configuredBaseDir, () => path.join(homeDirectory, ".d4"));
  ...
  const userDataDirName = isDevelopment ? "d4-dev" : "d4";
  // Never adopt T3 Code's profile: the resolver uses an existing legacy path directly.
  ...
  return DesktopEnvironment.of({
    ...
    appUserModelId: Option.getOrElse(config.appUserModelIdOverride, () =>
      isDevelopment ? "com.d4.desktop.dev" : "com.d4.desktop",
    ),
    linuxDesktopEntryName: isDevelopment ? "d4-dev.desktop" : "d4.desktop",
    linuxWmClass: isDevelopment ? "d4-dev" : "d4",
    userDataDirName,
