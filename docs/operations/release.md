...
2. Create an explicit App ID for `com.d4.desktop` and enable Associated Domains.
...
- macOS build unsigned when expected signed:
  ...
  - Confirm the provisioning profile belongs to `APPLE_TEAM_ID.com.d4.desktop` and includes
    Associated Domains.
